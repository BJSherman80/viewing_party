...
jake.parties.create!(date: "1999-12-31", start_time: "11:59", party_duration: 600, movie_id: jake_movie.id)
dani.parties.create!(date: "2008-07-14", start_time: "7:25", party_duration: 160, movie_id: dani_movie.id)
brett.parties.create!(date: "1860-09-19", start_time: "4:20", party_duration: 500, movie_id: brett_movie.id)
